...
← Volver al catálogo
</a> ${id ? renderTemplate`${renderComponent($$result2, "VehicleDetail", VehicleDetail, { "vehicleId": id, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/yoshi/Desktop/randy/icarsolutions/frontend/src/components/VehicleDetail", "client:component-export": "default" })}` : renderTemplate`<p>ID no encontrado</p>`} </div> ` })}`;
